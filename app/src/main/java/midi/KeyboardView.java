...
public class KeyboardView extends View {
    ...
    private int mNumPortraitKeys = NOTES_PER_OCTAVE + 3;
    private int mNumLandscapeKeys = (2 * NOTES_PER_OCTAVE) + 3;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        mWidth = w;
        mHeight = h;
        mNumKeys = (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) ? mNumPortraitKeys : mNumLandscapeKeys;
        mNumWhiteKeys = 0;
        // Count white keys.
    ...
    // handle making sound
    private MediaPlayer pianoMediaPlayer = new MediaPlayer();
